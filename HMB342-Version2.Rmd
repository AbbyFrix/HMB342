...
ggplot(edv_attachment_65_79_comb, aes(x = attached_rate_65_79, y = high_urgency_65_79)) +
  ...
  geom_line(data = new_data, aes(x = attached_rate_65_79, y = predict), color = "black", size = 1.2) +  # Prediction line
  labs(
...
edv_attachment_0_4_comb <- full_join(edv_low_high_0_4, edv_attachment_5_19_comb$pc_attachment_under_19,
            by = c("neighborhood_name"))
